...
var ce = class {
	...
	u(e) {
		...
		for (; s !== void 0;) {
			if (a === s.index) {
				let t;
				s.type === 2 ? t = new G(i, i.nextSibling, this, e) : s.type === 1 ? t = new s.ctor(i, s.name, s.strings, this, e) : s.type === 6 && (t = new fe(i, this, e)), this._$AV.push(t), s = n[++o];
			}
...
pe?.(U, G), (y.litHtmlVersions ??= []).push("3.3.3");
var me = (e, t, n) => {
...
he?.({ LitElement: J }), (q.litElementVersions ??= []).push("4.2.2");
//#endregion
...
var Z = class extends J {
	hass;
	config = { type: "custom:codex-usage-card" };
	setConfig(e) {
		if (e.type !== "custom:codex-usage-card") throw Error("Invalid card type");
		this.config = structuredClone(e);
	}
	render() {
		return oe`<ha-card><div>Codex Usage</div></ha-card>`;
	}
};
X([ve({ attribute: !1 })], Z.prototype, "hass", void 0), Z = X([Y("codex-usage-card")], Z);
var Q = class extends J {};
Q = X([Y("codex-usage-card-editor")], Q);
//#endregion
//#region src/index.ts
var $ = {
...
window.customCards ??= [], window.customCards.some((e) => e.type === $.type) || window.customCards.push($);
//#endregion
